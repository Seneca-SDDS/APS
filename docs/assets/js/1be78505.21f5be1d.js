  ...
  [514, 972],
  {
    9963: (e, t, n) => {
      ...
      const N = 'collapseSidebarButton_PEFL',
        S = 'collapseSidebarButtonIcon_kv0_';
      function Z(e) {
        let { onClick: t } = e;
        return a.createElement(
          'button',
      ...
      function H(e) {
        ...
        const { items: m, label: u, collapsible: b, className: p, href: h } = t,
          ...
          g = (0, i._F)(t, o),
          v = (0, A.Mg)(h, o),
          { collapsed: k, setCollapsed: I } = (0, M.u)({
            initialState: () => !!b && !g && t.collapsed,
          }),
          { expandedItem: N, setExpandedItem: S } = (function () {
            const e = (0, a.useContext)(w);
            if (e === y) throw new x.i6('DocSidebarItemsExpandedStateProvider');
            return e;
          })(),
          Z = function (e) {
            void 0 === e && (e = !k), S(e ? null : s), I(e);
          };
        return (
          (function (e) {
      ...
      const j = (0, a.memo)(O),
        q = 'menu_SIkG',
        G = 'menuWithAnnouncementBar_GW3s';
      function Y(e) {
        ...
        return a.createElement(
          'nav',
          { className: (0, l.Z)('menu thin-scrollbar', q, c && G, o) },
          a.createElement(
            'ul',
      ...
      function de(e) {
        ...
        return a.createElement(
          ...
          a.createElement(I, { className: se })
        );
      }
      const me = 'docSidebarContainer_b6E3',
        ue = 'docSidebarContainerHidden_b3ry';
      function be(e) {
        let { children: t } = e;
        const n = (0, d.V)();
      ...
      function pe(e) {
        ...
        return a.createElement(
          'aside',
          {
            className: (0, l.Z)(r.k.docs.docSidebarContainer, me, n && ue),
            onTransitionEnd: (e) => {
              e.currentTarget.classList.contains(me) && n && s(!0);
            },
          },
          a.createElement(
            be,
        ...
        return a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(
              s.q,
              { version: t },
              a.createElement(d.b, { name: m, items: u }, a.createElement(ve, null, c))
            )
          )
        );
      }
    ...
    4972: (e, t, n) => {
      ...
      function c() {
        return a.createElement(
          ...
          null,
          a.createElement(o.d, {
            title: (0, l.I)({ id: 'theme.NotFound.title', message: 'Page Not Found' }),
          }),
          a.createElement(
            r.Z,
            null,
