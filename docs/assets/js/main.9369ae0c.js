/*! For license information please see main.9369ae0c.js.LICENSE.txt */
  ...
  [179],
  {
    723: (e, t, n) => {
      ...
      var r = n(7294),
        ...
        l = n(6887);
      const s = {
        '0e384e19': [() => n.e(671).then(n.bind(n, 9881)), '@site/docs/intro.md', 9881],
        17896441: [
          () => Promise.all([n.e(532), n.e(918)]).then(n.bind(n, 4285)),
          '@theme/DocItem',
          4285,
        ],
        '1be78505': [
        ...
        '5b86058e': [
          () => n.e(840).then(n.t.bind(n, 3769, 19)),
          'W:\\_Git\\Git-Seneca\\Seneca-SDDS\\APS\\.docusaurus\\docusaurus-plugin-content-docs\\default\\plugin-route-context-module-100.json',
          3769,
        ],
        '935f2afb': [
        ...
        return t
          ? r.createElement(
              ...
              r.createElement(
                'div',
                null,
                r.createElement('button', { type: 'button', onClick: n }, 'Retry')
              )
            )
          : a
          ? r.createElement(
        ...
        return (
          ...
          i().Map({
            ...
            render(t, n) {
              ...
              return (
                delete i.__context,
                r.createElement(d.z, { value: s }, r.createElement(l, (0, a.Z)({}, i, n)))
              );
            },
          })
        );
    ...
    9383: (e, t, n) => {
      ...
      var r = n(7294),
        ...
        i = n(405),
        l = n(412);
      const s = [n(2497), n(3310), n(8320), n(2295), n(8968), n(3240)];
      var u = n(723),
        c = n(6550),
        d = n(8790);
      function f(e) {
      ...
      function P(e) {
        for (var t = arguments.length, n = new Array(t > 1 ? t - 1 : 0), r = 1; r < t; r++)
          n[r - 1] = arguments[r];
        const a = s.map((t) => (t.default?.[e] ?? t[e])?.(...n));
      ...
      class O extends r.Component {
        ...
        shouldComponentUpdate(e, t) {
          ...
          return (
            ...
            (this.routeUpdateCleanupCb = P('onRouteUpdate', {
      ...
      const W = new Set(),
        ...
        K = {
          prefetch(e) {
            if (!((e) => !Y() && !V.has(e) && !W.has(e))(e)) return !1;
            W.add(e);
            ...
            return Promise.all(
              t.map((e) => {
                const t = n.gca(e);
                return t && !t.includes('undefined') ? H(t).catch(() => {}) : Promise.resolve();
              })
            );
          },
          preload: (e) => !!((e) => !Y() && !V.has(e))(e) && (V.add(e), N(e)),
        },
        Q = Object.freeze(K);
      if (l.Z.canUseDOM) {
        window.docusaurus = Q;
    ...
    8940: (e, t, n) => {
      ...
      var r = n(7294),
        a = n(6809);
      const o = JSON.parse(
          '{"docusaurus-plugin-content-docs":{"default":{"path":"/APS/","versions":[{"name":"current","label":"Next","isLast":true,"path":"/APS/","mainDocId":"intro","docs":[{"id":"intro","path":"/APS/","sidebar":"courseNotesSidebar"}],"draftIds":[],"sidebars":{"courseNotesSidebar":{"link":{"path":"/APS/","label":"intro"}}}}],"breadcrumbs":true}}}'
        ),
        i = JSON.parse(
      ...
      var l = n(7529);
      const s = JSON.parse(
          '{"docusaurusVersion":"2.2.0","siteVersion":"0.0.0","pluginVersions":{"docusaurus-plugin-content-docs":{"type":"package","name":"@docusaurus/plugin-content-docs","version":"2.2.0"},"docusaurus-plugin-content-blog":{"type":"package","name":"@docusaurus/plugin-content-blog","version":"2.2.0"},"docusaurus-plugin-content-pages":{"type":"package","name":"@docusaurus/plugin-content-pages","version":"2.2.0"},"docusaurus-plugin-sitemap":{"type":"package","name":"@docusaurus/plugin-sitemap","version":"2.2.0"},"docusaurus-theme-classic":{"type":"package","name":"@docusaurus/theme-classic","version":"2.2.0"},"docusaurus-plugin-pwa":{"type":"package","name":"@docusaurus/plugin-pwa","version":"2.2.0"}}}'
        ),
        u = { siteConfig: a.Z, siteMetadata: s, globalData: o, i18n: i, codeTranslations: l },
        c = r.createContext(u);
      function d(e) {
        let { children: t } = e;
    ...
    9960: (e, t, n) => {
      ...
      function f(e, t) {
        ...
        let _ = void 0 !== T ? ((A = T), v && ((e) => e.startsWith('/'))(A) ? k(A) : A) : void 0;
        var A;
        ...
        const L = (0, a.useRef)(!1),
          ...
          N = (0, a.useRef)(),
          O = () => {
            L.current || null == _ || (window.docusaurus.preload(_), (L.current = !0));
          };
        (0, a.useEffect)(
          () => (
    ...
    8968: (e, t, n) => {
      ...
      var r = n(412),
        a = n(12);
      const o = ['standalone', 'queryString'],
        i = (0, a.W)('docusaurus.pwa.event.appInstalled.fired');
      function l(e, t) {
        false;
      }
      async function s() {
        ...
        l(),
          await Promise.all(e.map((e) => e.unregister().then((e) => l()))),
          l(),
        ...
        appInstalled: () =>
          ...
          (async function () {
            return (
              ...
              (await navigator.getInstalledRelatedApps()).some((e) => 'webapp' === e.platform)
            );
          })(),
        standalone: () => window.matchMedia('(display-mode: standalone)').matches,
        queryString: () =>
          'true' === new URLSearchParams(window.location.search).get('offlineMode'),
      };
      async function c() {
        const e = await (async function () {
            return (
              await Promise.all(o.map((e) => Promise.resolve(u[e]()).then((t) => (t ? e : void 0))))
            ).filter(Boolean);
          })(),
          t = e.length > 0;
        return l(), t;
      ...
      r.Z.canUseDOM &&
        ...
        'serviceWorker' in navigator &&
          ...
          l(),
          (async function () {
            const [{ Workbox: e }, t] = await Promise.all([n.e(131).then(n.bind(n, 5131)), c()]),
              r = new e(
                (function (e) {
                  const t = JSON.stringify(e),
                    n = `/APS/sw.js?params=${encodeURIComponent(t)}`;
                  return l(), n;
                })({ offlineMode: t, debug: !1 })
              ),
            ...
            const i = await r.register();
            i && (i.active && l(), i.installing && l(), i.waiting && (l(), await o()));
    ...
    3285: (e, t, n) => {
      ...
      function T(e) {
        ...
        return r.createElement(
          'div',
          (0, l.Z)({}, e, {
            className: (0, a.Z)(C, e.className),
            dangerouslySetInnerHTML: { __html: n },
          })
        );
      }
      const _ = 'announcementBar_mb4j',
        A = 'announcementBarPlaceholder_vyr4',
        L = 'announcementBarClose_gvF7',
      ...
      function R() {
        ...
        return r.createElement(
          'div',
          { className: _, style: { backgroundColor: a, color: o }, role: 'banner' },
          i && r.createElement('div', { className: A }),
          r.createElement(T, { className: P }),
          i && r.createElement(x, { onClick: n, className: L })
        );
      }
      var N = n(2961),
        O = n(2466);
      ...
      function j() {
        ...
        if (!e) throw new D.i6('NavbarSecondaryMenuDisplayProvider');
        const [t, n] = e,
      ...
      function Z(e) {
        ...
        return r.createElement(
          'div',
          { className: (0, a.Z)(H.toggle, t) },
          r.createElement(
            'button',
            {
              className: (0, a.Z)('clean-btn', H.toggleButton, !i && H.toggleButtonDisabled),
              type: 'button',
            ...
            r.createElement(q, { className: (0, a.Z)(H.toggleIcon, H.lightToggleIcon) }),
            r.createElement(G, { className: (0, a.Z)(H.toggleIcon, H.darkToggleIcon) })
          )
        );
      }
      const W = r.memo(Z);
      function V(e) {
        ...
        const n = (0, w.L)().colorMode.disableSwitch,
          { colorMode: a, setColorMode: o } = (0, U.I)();
        return n ? null : r.createElement(W, { className: t, value: a, onChange: o });
      }
      var Y = n(1327);
      function K() {
      ...
      function ae(e) {
        ...
        const f = (0, ee.Z)(a),
          p = (0, ee.Z)(t),
          m = (0, ee.Z)(o, { forcePrependBaseUrl: !0 }),
          h = i && o && !(0, te.Z)(o),
          g = s
            ...
            : {
                children: r.createElement(
                  ...
                  null,
                  i,
                  h && r.createElement(re.Z, u && { width: 12, height: 12 })
                ),
              };
        return o
          ? r.createElement(J.Z, (0, l.Z)({ href: c ? m : o }, d, g))
          : r.createElement(
              J.Z,
              (0, l.Z)(
                { to: f, isNavLink: !0 },
                (t || n) && {
                  isActive: (e, t) => (n ? ne(n, t.pathname) : t.pathname.startsWith(p)),
                },
                d,
                g
              )
      ...
      function ie(e) {
        ...
        return r.createElement(
          ...
          r.createElement(ae, (0, l.Z)({ className: (0, a.Z)('menu__link', t) }, o))
        );
      }
      function le(e) {
        ...
        return r.createElement(
          ...
          (0, l.Z)({}, a, {
            activeClassName:
              a.activeClassName ?? (t ? 'menu__link--active' : 'navbar__link--active'),
          })
        );
      }
      var se = n(6043),
      ...
      const ve = 'iconLanguage_nlXk';
      var be = n(1875);
      const ye = 'searchBox_ZlJk';
      function we(e) {
        let { children: t, className: n } = e;
        return r.createElement('div', { className: (0, a.Z)(n, ye) }, t);
      }
      var ke = n(143),
        Ee = n(2802);
      var Se = n(373);
      ...
      const Ce = {
        ...
        localeDropdown: function (e) {
          ...
          return r.createElement(
            ...
            (0, l.Z)({}, o, {
              mobile: t,
              label: r.createElement(r.Fragment, null, r.createElement(ge, { className: ve }), g),
              items: h,
            })
          );
        },
        search: function (e) {
          ...
          return t ? null : r.createElement(we, { className: n }, r.createElement(be.Z, null));
        },
        dropdown: me,
        html: function (e) {
        ...
        docsVersion: function (e) {
          ...
          return r.createElement(le, (0, l.Z)({}, o, { label: s, to: u }));
        },
        docsVersionDropdown: function (e) {
          ...
          const { search: d, hash: f } = (0, s.TH)(),
            p = (0, ke.Iw)(n),
            m = (0, ke.gB)(n),
            { savePreferredVersionName: h } = (0, Se.J)(n),
            g = [
              ...o,
              ...m.map((e) => {
            ...
            b =
              t && g.length > 1
                ...
                : v.label,
            y = t && g.length > 1 ? void 0 : xe(v).path;
          return g.length <= 1
            ? r.createElement(
                le,
                (0, l.Z)({}, c, { mobile: t, label: b, to: y, isActive: a ? () => !1 : void 0 })
              )
            : r.createElement(
                me,
                (0, l.Z)({}, c, {
      ...
      function _e() {
        ...
        return r.createElement(
          ...
          t.map((t, n) =>
            r.createElement(Te, (0, l.Z)({ mobile: !0 }, t, { onClick: () => e.toggle(), key: n }))
          )
        );
      }
      function Ae(e) {
      ...
      function Ie(e) {
        ...
        return r.createElement(
          'svg',
          (0, l.Z)(
            { className: a, width: t, height: n, viewBox: '0 0 30 30', 'aria-hidden': 'true' },
            o
          ),
          r.createElement('path', {
            stroke: 'currentColor',
      ...
      function ze() {
        ...
        return r.createElement(je, {
          left: r.createElement(
            r.Fragment,
            null,
            !e.disabled && r.createElement(Me, null),
            r.createElement(K, null),
            r.createElement(Be, { items: n })
          ),
          right: r.createElement(
            r.Fragment,
            null,
            r.createElement(Be, { items: a }),
            r.createElement(V, { className: Fe }),
            !o && r.createElement(we, null, r.createElement(be.Z, null))
          ),
        });
      }
      function Ue() {
      ...
      function $e(e) {
        ...
        const { to: n, href: a, label: o, prependBaseUrlToHref: i, ...s } = t,
          u = (0, ee.Z)(n),
          c = (0, ee.Z)(a, { forcePrependBaseUrl: !0 });
        return r.createElement(
          J.Z,
          (0, l.Z)({ className: 'footer__link-item' }, a ? { href: i ? c : a } : { to: u }, s),
          o,
          a && !(0, te.Z)(a) && r.createElement(re.Z, null)
        );
      }
      function qe(e) {
        let { item: t } = e;
      ...
      function Ge(e) {
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            t.items.map((e, t) => r.createElement(qe, { key: t, item: e }))
          )
        );
      }
      function He(e) {
        ...
        return r.createElement(
          ...
          t.map((e, t) => r.createElement(Ge, { key: t, column: e }))
        );
      }
      function Ze() {
          ...
          r.createElement(
            ...
            t.map((e, n) =>
              r.createElement(
                r.Fragment,
                { key: n },
                r.createElement(We, { item: e }),
                t.length !== n + 1 && r.createElement(Ze, null)
              )
            )
          )
        );
      ...
      function Ye(e) {
        ...
        return (function (e) {
          ...
          ? r.createElement(He, { columns: t })
          : r.createElement(Ve, { links: t });
      }
      var Ke = n(941);
      const Qe = 'footerLogoLink_BH7S';
      function Xe(e) {
        let { logo: t } = e;
        const { withBaseUrl: n } = (0, ee.C)(),
      ...
      function Je(e) {
        ...
        return t.href
          ? r.createElement(
              J.Z,
              { href: t.href, className: Qe, target: t.target },
              r.createElement(Xe, { logo: t })
            )
          : r.createElement(Xe, { logo: t });
      }
      function et(e) {
      ...
      function nt() {
        ...
        return r.createElement(tt, {
          style: o,
          links: n && n.length > 0 && r.createElement(Ye, { links: n }),
          logo: a && r.createElement(Je, { logo: a }),
          copyright: t && r.createElement(et, { copyright: t }),
        });
      }
      const rt = r.memo(nt);
      var at = n(12);
      const ot = 'docusaurus.tab.',
        it = r.createContext(void 0);
      const lt = (0, D.Qc)([
        U.S,
        k.pl,
        function (e) {
          ...
          const n = (function () {
            ...
            return (0, r.useMemo)(() => ({ tabGroupChoices: e, setTabGroupChoices: a }), [e, a]);
          })();
          return r.createElement(it.Provider, { value: n }, t);
        },
        O.OC,
        Se.L5,
        i.VC,
        function (e) {
          ...
          return r.createElement(
            I.n2,
            null,
            r.createElement(N.M, null, r.createElement(F, null, t))
          );
        },
      ]);
      function st(e) {
      ...
      function dt(e) {
        ...
        return (
          ...
          r.createElement(
            ...
            r.createElement(
              'div',
              { id: d, className: (0, a.Z)(g.k.wrapper.main, ct, l) },
              r.createElement(o.Z, { fallback: (e) => r.createElement(ut, e) }, t)
            ),
            !n && r.createElement(rt, null)
          )
        );
      }
    },
    ...
    6043: (e, t, n) => {
      ...
      function c(e) {
        ...
        (0, a.useEffect)(() => {
          ...
          function a() {
            ...
            return { transition: `height ${n}ms ${r?.easing ?? 'ease-in-out'}`, height: `${t}px` };
          }
          function i() {
            const t = a();
      ...
      function f(e) {
        ...
        return (
          c({ collapsibleRef: f, collapsed: n, animation: o }),
          a.createElement(
            t,
            {
              ref: f,
              style: s ? void 0 : d(n),
              onTransitionEnd: (e) => {
                'height' === e.propertyName && (u(f.current, n), i?.(n));
              },
              className: l,
            },
            r
      ...
      function p(e) {
        ...
        return (
          ...
          o ? a.createElement(f, (0, r.Z)({}, n, { collapsed: l })) : null
        );
      }
      function m(e) {
        let { lazy: t, ...n } = e;
    ...
    2949: (e, t, n) => {
      ...
      function m() {
        const {
          ...
          [o, i] = (0, r.useState)(
            ((e) =>
              a.Z.canUseDOM ? p(document.documentElement.getAttribute('data-theme')) : p(e))(e)
          );
        (0, r.useEffect)(() => {
          t && c.del();
        }, [t]);
        const s = (0, r.useCallback)(
          function (t, r) {
            ...
            t
              ...
              : (i(n ? (window.matchMedia('(prefers-color-scheme: dark)').matches ? f : d) : e),
                c.del());
          },
          [n, e]
        );
        ...
        return (
          (0, r.useEffect)(() => {
            ...
            const e = window.matchMedia('(prefers-color-scheme: dark)'),
              r = () => {
                window.matchMedia('print').matches || m.current
                  ? (m.current = window.matchMedia('print').matches)
                  : s(null);
              };
    ...
    373: (e, t, n) => {
      ...
      const c = (e) => `docs-preferred-version-${e}`,
        ...
        f = (e, t) => (0, u.W)(c(e), { persistence: t }).get(),
        p = (e, t) => {
    ...
    2802: (e, t, n) => {
      ...
      function g() {
        ...
        return !1 !== n && e ? h({ sidebarItems: e.items, pathname: t }) : null;
      }
      function v(e) {
    ...
    2466: (e, t, n) => {
      ...
      const c = () =>
        a.Z.canUseDOM ? { scrollX: window.pageXOffset, scrollY: window.pageYOffset } : null;
      function d(e, t) {
        void 0 === t && (t = []);
    ...
    3240: () => {
      'undefined' != typeof window &&
        window.addEventListener('beforeinstallprompt', (e) => {
          const t = document.querySelector('#pwa-button');
          e.preventDefault(),
    ...
    9318: (e, t, n) => {
      'use strict';
      n.d(t, { lX: () => w, q_: () => T, ob: () => p, PP: () => A, Ep: () => f });
      var r = n(7462);
      function a(e) {
        return '/' === e.charAt(0);
      }
      ...
      function w(e) {
        ...
        function j(e) {
          1 === (B += e) && 1 === e
            ? (window.addEventListener(v, P), o && window.addEventListener(b, R))
            : 0 === B && (window.removeEventListener(v, P), o && window.removeEventListener(b, R));
        }
        var z = !1;
        var U = {
          length: n.length,
      ...
      function T(e) {
        ...
        var _ = m();
        function A(e) {
          (0, r.Z)(z, e), (z.length = t.length), _.notifyListeners(z.location, z.action);
        }
        var L = !1,
          P = null;
        function R() {
        ...
        var z = {
          ...
          createHref: function (e) {
            var t = document.querySelector('base'),
              n = '';
            return (
              t && t.getAttribute('href') && (n = S(window.location.href)), n + '#' + y(v + f(e))
            );
          },
          push: function (e, t) {
            var n = 'PUSH',
                  ...
                  for (
                    ...
                    if (!(x instanceof a)) {
                      ...
                      if (
                        ...
                        u(t, I, T),
                        (E = s(t, I, new a(f, g ? r.tokenize(R, g) : R, y, R))),
                        O && s(t, E, O),
                        T > 1)
                      ) {
          ...
          return (
            (a.stringify = function e(t, n) {
              ...
              var o = {
                ...
                i = t.alias;
              i &&
                (Array.isArray(i) ? Array.prototype.push.apply(o.classes, i) : o.classes.push(i)),
                r.hooks.run('wrap', o);
              var l = '';
    ...
    4448: (e, t, n) => {
      ...
      function w(e, t, n, r) {
        ...
        (null !== a
          ...
          r || null === a
            ? (function (e) {
                return (
                  !!p.call(h, e) || (!p.call(m, e) && (f.test(e) ? (h[e] = !0) : ((m[e] = !0), !1)))
                );
      ...
      function ne(e, t) {
        ...
        t.hasOwnProperty('value')
          ? ae(e, t.type, n)
          : t.hasOwnProperty('defaultValue') && ae(e, t.type, V(t.defaultValue)),
      ...
      function Ne() {
        if (Ae) {
          var e = Ae,
            t = Le;
          if (((Le = Ae = null), Pe(e), t)) for (e = 0; e < t.length; e++) Pe(t[e]);
        }
      }
      function Oe(e, t) {
        return e(t);
      ...
      function It(e, t) {
        for (var n = 0; n < e.length; n += 2) {
          var r = e[n],
            a = e[n + 1];
          (a = 'on' + (a[0].toUpperCase() + a.slice(1))), Ot.set(r, t), Nt.set(r, a), u(a, [r]);
        }
      }
      (0, o.unstable_now)();
      var Mt = 8;
                ...
                if (
                  (function (e, t, n, r, a) {
                    switch (t) {
                      ...
                      case 'gotpointercapture':
                        return (
                          (o = a.pointerId), dt.set(o, gt(dt.get(o) || null, e, t, n, r, a)), !0
                        );
                    }
                    return !1;
                  })(o, e, t, n, r)
      ...
      var Ln = a({}, mn, {
        ...
        On = sn(a({}, fn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 })),
        Dn = a({}, gn, {
          deltaX: function (e) {
      ...
      function Lr(e, t) {
        ...
        if (Ze) throw ((e = We), (Ze = !1), (We = null), e);
      }
      function Pr(e, t) {
        var n = ia(t),
          r = e + '__bubble';
        ...
        !(function (e, t, n) {
            ...
            if (void 0 !== l) {
              ...
              for (var p, m = r; null !== m; ) {
                ...
                if (
                  (5 === p.tag &&
                    null !== h &&
                    ((p = h), null !== f && null != (h = ze(m, f)) && c.push(Mr(m, h, p))),
                  d)
                )
                  break;
                m = m.return;
          ...
          if (0 == (7 & t)) {
            if (
              ...
              if (
                ...
                ('pointerout' !== e && 'pointerover' !== e) ||
                  ((c = Rn), (h = 'onPointerLeave'), (f = 'onPointerEnter'), (m = 'pointer')),
                (d = null == s ? l : aa(s)),
                (p = null == u ? l : aa(u)),
            ...
            switch (
              ...
              case 'focusin':
                (Wn(v) || 'true' === v.contentEditable) && ((yr = v), (wr = r), (kr = null));
                break;
              case 'focusout':
                kr = wr = yr = null;
                break;
      ...
      function ra(e) {
        return !(e = e[Xr] || e[ea]) || (5 !== e.tag && 6 !== e.tag && 13 !== e.tag && 3 !== e.tag)
          ? null
          : e;
      }
      function aa(e) {
      ...
      function Ya() {
        if (!Ua && null !== ja) {
          ...
          try {
            ...
            throw (null !== ja && (ja = ja.slice(e + 1)), Ta(Na, Va), n);
          } finally {
            Ua = !1;
          }
        }
      ...
      function mo(e, t, n, r) {
        ...
        if (null !== s) {
          ...
          if (null !== d) {
            ...
            f !== l &&
              (null === f ? (d.firstBaseUpdate = c) : (f.next = c), (d.lastBaseUpdate = u));
          }
        }
        if (null !== i) {
            ...
            if ((r & s) === s) {
              ...
              e: {
                ...
                switch (((s = t), (p = n), h.tag)) {
                  ...
                  case 0:
                    if (null == (s = 'function' == typeof (m = h.payload) ? m.call(p, f, s) : m))
                      break e;
                    f = a({}, f, s);
                    break e;
                  case 2:
      ...
      function To(e) {
        ...
        function u(e, t, n, r) {
          return null !== t && t.elementType === n.type
            ...
            : (((r = Ws(n.type, n.key, n.props, null, e.mode, r)).ref = xo(e, t, n)),
              (r.return = e),
              r);
        }
        function c(e, t, n, r) {
        ...
        function f(e, t, n) {
          ...
          if ('object' == typeof t && null !== t) {
            switch (t.$$typeof) {
              case E:
                return (
                  ((n = Ws(t.type, t.key, t.props, null, e.mode, n)).ref = xo(e, null, t)),
                  (n.return = e),
                  n
                );
              case S:
            ...
            if (So(t) || $(t)) return ((t = Vs(t, e.mode, n, null)).return = e), t;
            Co(e, t);
          }
          return null;
        }
            ...
            switch (o.$$typeof) {
              case E:
                e: {
                  ...
                  o.type === x
                    ? (((r = Vs(o.props.children, e.mode, s, o.key)).return = e), (e = r))
                    : (((s = Ws(o.type, o.key, o.props, null, e.mode, s)).ref = xo(e, r, o)),
                      (s.return = e),
                      (e = s));
                }
                return l(e);
      ...
      function Do(e, t) {
        switch ((da(No, t), da(Ro, e), da(Po, Lo), (e = t.nodeType))) {
          case 9:
          case 11:
          ...
          if (t) {
            ...
            if (!Go(e, t)) {
              if (!(t = Vr(n.nextSibling)) || !Go(e, t))
                return (e.flags = (-1025 & e.flags) | 2), ($o = !1), void (zo = e);
              qo(zo, n);
            }
      ...
      function li(e, t, n, r, a, o) {
        if (
          ...
          (t.updateQueue = null),
          (t.lanes = 0),
          (Qo.current = null === e || null === e.memoizedState ? Oi : Di),
          (e = n(r, a)),
          ai)
        ) {
          o = 0;
          do {
            ...
            (o += 1), (ni = ti = null), (t.updateQueue = null), (Qo.current = Ii), (e = n(r, a));
          } while (ai);
        }
        if (
          ((Qo.current = Ni),
        ...
        if (
          (null !== a
            ...
            : ((e = e.mutableReadLanes),
              (e = (Jo & e) === e) && ((t._workInProgressVersionPrimary = r), Yo.push(t))),
          e)
        )
          return n(t._source);
      ...
      function zi(e, t, n, r, a, o) {
        if (null === e) {
          ...
          return 'function' != typeof i ||
            ...
            ? (((e = Ws(n.type, null, r, t, t.mode, o)).ref = t.ref), (e.return = t), (t.child = e))
      ...
      function tl(e, t, n, r, a) {
        ...
        return (
          0 == (2 & o) && t.child !== i
            ...
            : (n = Zs(i, l)),
          null !== e ? (r = Zs(e, r)) : ((r = Vs(r, o, a, null)).flags |= 2),
          (r.return = t),
          (n.return = t),
          (n.sibling = r),
          (t.child = n),
      ...
      function al(e, t, n) {
        var r = t.pendingProps,
          a = r.revealOrder,
          o = r.tail;
        if ((Bi(e, t, r.children, n), 0 != (2 & (r = Bo.current))))
          (r = (1 & r) | 2), (t.flags |= 64);
        else {
            ...
            if (((n = t.type), null !== e && null != t.stateNode))
              ...
              if (((e = Oo(Po.current)), Wo(t))) {
                ...
                switch (
                  ...
                  case 'video':
                  case 'audio':
                    for (o = 0; o < Tr.length; o++) Pr(Tr[o], e);
                    o = r;
                    break;
                  case 'source':
                    Pr('error', e), (o = r);
      ...
      function sl(e) {
        switch (e.tag) {
          ...
          case 3:
            if ((Io(), ca(ma), ca(pa), Ko(), 0 != (64 & (t = e.flags)))) throw Error(i(285));
      ...
      function Tl(e, t) {
        switch (t.tag) {
          ...
          case 13:
            return null !== t.memoizedState && ((Hl = qa()), bl(t.child, !0)), void _l(t);
          case 19:
            return void _l(t);
          case 23:
          case 24:
      ...
      var Vl,
        ...
        ds = !1;
      function fs() {
        return 0 != (48 & Nl) ? qa() : -1 !== ls ? ls : (ls = qa());
      }
      function ps(e) {
        if (0 == (2 & (e = e.mode))) return 1;
        if (0 == (4 & e)) return 99 === Ga() ? 1 : 2;
        if ((0 === ss && (ss = zl), 0 !== Ka.transition)) {
          0 !== us && (us = null !== Gl ? Gl.pendingLanes : 0), (e = ss);
          var t = 4186112 & ~us;
      ...
      function ms(e, t, n) {
        ...
        qt(e, t, n), e === Ol && (($l |= t), 4 === Bl && bs(e, Il));
        var r = Ga();
        1 === t
          ? 0 != (8 & Nl) && 0 == (48 & Nl)
            ? ys(e)
      ...
      function gs(e, t) {
        ...
        if (((r = Bt(e, e === Ol ? Il : 0)), (t = Mt), 0 === r))
          null !== n && (n !== Fa && _a(n), (e.callbackNode = null), (e.callbackPriority = 0));
        else {
          if (null !== n) {
          ...
          15 === t
            ? ((n = ys.bind(null, e)),
              null === ja ? ((ja = [n]), (za = Ta(Na, Ya))) : ja.push(n),
              (n = Fa))
            : 14 === t
      ...
      function vs(e) {
        ...
        if (
          ...
          if (
            ...
            throw ((t = jl), xs(e, 0), bs(e, n), gs(e, qa()), t);
          switch (((e.finishedWork = e.current.alternate), (e.finishedLanes = n), r)) {
            ...
            case 5:
              ...
              break;
            case 3:
              if ((bs(e, n), (62914560 & n) === n && 10 < (r = Hl + 500 - qa()))) {
                if (0 !== Bt(e, 0)) break;
        ...
        return gs(e, qa()), e.callbackNode === t ? vs.bind(null, e) : null;
      }
      function bs(e, t) {
        for (
          t &= ~ql, t &= ~$l, e.suspendedLanes |= t, e.pingedLanes &= ~t, e = e.expirationTimes;
          0 < t;
      ...
      function ys(e) {
        ...
        if (
          ...
          throw ((n = jl), xs(e, 0), bs(e, t), gs(e, qa()), n);
        return (
          (e.finishedWork = e.current.alternate), (e.finishedLanes = t), Ns(e), gs(e, qa()), null
        );
      }
      function ws(e, t) {
        var n = Nl;
      ...
      function xs(e, t) {
        ...
        if ((-1 !== n && ((e.timeoutHandle = -1), Zr(n)), null !== Dl))
      ...
      function _s(e, t) {
        ...
        if ((no(), (Nl = n), (Pl.current = r), null !== Dl)) throw Error(i(261));
        return (Ol = null), (Il = 0), Bl;
      }
      function As() {
        for (; null !== Dl; ) Ps(Dl);
      }
      ...
      function Ns(e) {
        var t = Ga();
        return Za(99, Os.bind(null, e, t)), null;
      }
      function Os(e, t) {
        do {
          Is();
        ...
        if (
          ...
          if (((a = Nl), (Nl |= 32), (Rl.current = null), (Ur = Yt), vr((l = gr())))) {
          ...
          ($r = { focusedElem: l, selectionRange: s }), (Yt = !1), (cs = null), (ds = !1), (Yl = r);
          do {
            try {
              Ds();
            } catch (T) {
            ...
            try {
              for (y = e; null !== Yl; ) {
                ...
                if ((36 & S && vl(y, Yl.alternate, Yl), 128 & S)) {
                  ...
                  if (null !== x) {
                    var C = Yl.stateNode;
                    Yl.tag, (w = C), 'function' == typeof x ? x(w) : (x.current = w);
                  }
                }
                Yl = Yl.nextEffect;
              }
        ...
        if ((gs(e, qa()), Kl)) throw ((Kl = !1), (e = Ql), (Ql = null), e);
          ...
          for (var n = e.return; null !== n; ) {
            ...
            if (1 === n.tag) {
              ...
              if (
                ...
                if ((fo(n, a), (a = fs()), null !== (n = hs(n, 1)))) qt(n, 1, a), gs(n, a);
      ...
      function Us(e, t, n) {
        ...
        null !== r && r.delete(t),
          ...
          Ol === e &&
            (Il & n) === n &&
            (4 === Bl || (3 === Bl && (62914560 & Il) === Il && 500 > qa() - Hl)
              ? xs(e, 0)
              : (ql |= n)),
          gs(e, t);
      }
      ...
      function Ws(e, t, n, r, a, o) {
        ...
        if (((r = e), 'function' == typeof e)) Hs(e) && (l = 1);
          ...
          e: switch (e) {
            ...
            case C:
              ...
              break;
            case T:
              return ((e = Gs(12, n, t, 8 | a)).elementType = T), (e.type = T), (e.lanes = o), e;
            case P:
              return ((e = Gs(13, n, t, a)).type = P), (e.elementType = P), (e.lanes = o), e;
            case R:
              return ((e = Gs(19, n, t, a)).elementType = R), (e.lanes = o), e;
            case F:
              return Ys(n, a, o, t);
            case B:
              return ((e = Gs(24, n, t, a)).elementType = B), (e.lanes = o), e;
            default:
        ...
        return ((t = Gs(l, n, t, a)).elementType = e), (t.type = r), (t.lanes = o), t;
      }
      function Vs(e, t, n, r) {
      ...
      function Qs(e, t, n) {
        return (
          ((t = Gs(4, null !== e.children ? e.children : [], e.key, t)).lanes = n),
          (t.stateNode = {
      ...
      function au(e, t, n) {
        ...
        if (
          ...
          (t = Gs(3, null, null, 2 === t ? 7 : 1 === t ? 3 : 0)),
          (n.current = t),
          (t.stateNode = n),
          so(t),
          (e[ea] = n.current),
        ...
        switch (((t.lanes = 0), t.tag)) {
            ...
            if (
              ...
              if (
                ((o = (a = t.stateNode).hydrate) &&
                  ((Uo = Vr(t.stateNode.containerInfo.firstChild)), (zo = t), (o = $o = !0)),
                o)
              ) {
          ...
          case 4:
            return (
              Do(t, t.stateNode.containerInfo),
              (r = t.pendingProps),
              null === e ? (t.child = _o(t, null, r, n)) : Bi(e, t, r, n),
              t.child
            );
          case 11:
            return (
              ...
              if (null !== as) {
                ...
                (as = null),
                  e.forEach(function (e) {
                    (e.expiredLanes |= 24 & e.pendingLanes), gs(e, qa());
                  });
              }
              Va();
            })(),
      ...
      var su = { Events: [ra, aa, oa, Re, Ne, Is, { current: !1 }] },
        uu = {
      ...
      var g = {
        ...
        H = (function (e) {
          function t(n) {
            var r;
            return (
              ((r = e.call(this, n) || this).helmetData = new U(r.props.context, t.canUseDOM)), r
            );
          }
          return (
            p(t, e),
        ...
        c = (function (e) {
          function t() {
            for (var t, n = arguments.length, r = new Array(n), a = 0; a < n; a++)
              r[a] = arguments[a];
            return (
              ((t = e.call.apply(e, [this].concat(r)) || this).history = (0, i.lX)(t.props)), t
            );
          }
          return (
            (0, a.Z)(t, e),
      ...
      var y = b(function (e, t) {
        ...
        return o.createElement(r.s6.Consumer, null, function (e) {
          ...
          var n = w || e.location,
            ...
            s = i.pathname,
            _ = s && s.replace(/([.+*?=^!:${}()[\]|/\\])/g, '\\$1'),
            A = _ ? (0, r.LX)(n.pathname, { path: _, exact: h, sensitive: k, strict: E }) : null,
            L = !!(y ? y(A, n) : A),
          ...
          L &&
            ...
            (R = (0, l.Z)({}, R, p)));
          var N = (0, l.Z)({ 'aria-current': (L && a) || null, className: P, style: R, to: i }, T);
          return v !== b ? (N.ref = t || C) : (N.innerRef = C), o.createElement(g, N);
        });
      });
    },
    6550: (e, t, n) => {
              ...
              s = (function (e) {
                function n() {
                  for (var t, n = arguments.length, r = new Array(n), a = 0; a < n; a++)
                    r[a] = arguments[a];
                  return (
                    ((t = e.call.apply(e, [this].concat(r)) || this).emitter = h(t.props.value)), t
                  );
                }
                (0, r.Z)(n, e);
                var a = n.prototype;
        ...
        (t.unstable_scheduleCallback = function (e, o, i) {
          ...
          return (
            ...
            i > l
              ? ((e.sortIndex = i),
                E(_, e),
                null === S(T) && e === S(_) && (O ? a() : (O = !0), r(I, i - l)))
              : ((e.sortIndex = s), E(T, e), N || R || ((N = !0), n(M))),
            e
          );
        }),
    ...
    6809: (e, t, n) => {
      ...
      const r = {
        ...
        tagline: 'APS145',
        url: 'https://Seneca-SDDS.github.io',
        baseUrl: '/APS/',
        trailingSlash: !1,
        onBrokenLinks: 'throw',
        onBrokenMarkdownLinks: 'warn',
        favicon: 'img/favicon.ico',
        organizationName: 'Seneca-SDDS',
        projectName: 'APS',
        themeConfig: {
          navbar: {
            title: 'APS145 Applied Problem Solving',
            logo: { alt: 'Seneca College', src: 'img/logo.svg', srcDark: 'img/logo-dark.svg' },
            hideOnScroll: !1,
            items: [],
          },
          ...
          footer: {
            ...
            copyright: 'Copyright \xa9 2022 Seneca College.',
          },
          prism: {
            theme: {
        ...
        presets: [
          [
            ...
            {
              docs: {
                sidebarPath: 'W:\\_Git\\Git-Seneca\\Seneca-SDDS\\APS\\sidebars.js',
                routeBasePath: '/',
                editUrl: 'https://github.com/Seneca-SDDS/APS/tree/main',
                remarkPlugins: [null],
                rehypePlugins: [null],
              },
              theme: { customCss: 'W:\\_Git\\Git-Seneca\\Seneca-SDDS\\APS\\src\\css\\custom.css' },
            },
          ],
        ],
        stylesheets: [
        ...
        clientModules: ['W:\\_Git\\Git-Seneca\\Seneca-SDDS\\APS\\pwaCustomButton.js'],
        plugins: [
          [
            '@docusaurus/plugin-pwa',
            {
              ...
              pwaHead: [
                { tagName: 'link', rel: 'icon', href: 'img/pwa/icon-512x512.png' },
                { tagName: 'link', rel: 'manifest', href: '/manifest.json' },
                { tagName: 'meta', name: 'theme-color', content: '#DA291C' },
                ...
                { tagName: 'link', rel: 'apple-touch-icon', href: 'img/pwa/icon-192x192.png' },
                {
                  tagName: 'link',
                  rel: 'mask-icon',
                ...
                { tagName: 'meta', name: 'msapplication-TileColor', content: '#DA291C' },
              ],
            },
          ],
        ],
    ...
    6887: (e) => {
      ...
      e.exports = JSON.parse(
        '{"/APS/-711":{"__comp":"1be78505","__context":{"plugin":"5b86058e"},"versionMetadata":"935f2afb"},"/APS/-c47":{"__comp":"17896441","content":"0e384e19"}}'
      );
    },
  },
  (e) => {
