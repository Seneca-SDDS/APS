      ...
      var s = a.createContext({}),
        ...
        p = a.forwardRef(function (e, t) {
          var n = e.components,
            ...
            d = i(n),
            p = o,
            f = d[''.concat(s, '.').concat(p)] || d[p] || u[p] || r;
          return n
            ? a.createElement(f, l(l({ ref: t }, m), {}, { components: n }))
            : a.createElement(f, l({ ref: t }, m));
        });
      function f(e, t) {
        var n = arguments,
          o = t && t.mdxType;
        if ('string' == typeof e || o) {
          ...
          (c.originalType = e), (c[d] = 'string' == typeof e ? e : o), (l[1] = c);
    ...
    4285: (e, t, n) => {
      ...
      function _(e) {
        ...
        const {
          ...
          i = c ?? (d = s).docs.find((e) => e.id === d.mainDocId);
        var d;
        return a.createElement(
          'div',
          {
          ...
          a.createElement('div', null, a.createElement(C, { siteTitle: o, versionMetadata: n })),
          a.createElement(
            'div',
      ...
      function Z(e) {
        ...
        return n.badge
          ? a.createElement(
              'span',
              { className: (0, m.Z)(t, y.k.docs.docVersionBadge, 'badge badge--secondary') },
              a.createElement(
                p.Z,
        ...
        return a.createElement(
          ...
          a.createElement(
            p.Z,
            {
              ...
              values: {
                atDate:
                  t && n ? a.createElement(x, { lastUpdatedAt: t, formattedLastUpdatedAt: n }) : '',
      ...
      function P(e) {
        ...
        return a.createElement(
          f.Z,
          { href: t, className: (0, m.Z)(S, o ? I : M) },
          n,
      ...
      function V(e) {
        ...
        return a.createElement(
          ...
          a.createElement(
            'ul',
            { className: (0, m.Z)(U, 'padding--none', 'margin-left--sm') },
            t.map((e) => {
              let { label: t, permalink: n } = e;
              return a.createElement(
                'li',
                { key: n, className: z },
                a.createElement(P, { label: t, permalink: n })
              );
            })
          )
        );
      }
      const D = 'lastUpdated_vwxv';
      function R(e) {
        return a.createElement(
          'div',
          { className: (0, m.Z)(y.k.docs.docFooterTagsRow, 'row margin-bottom--sm') },
          a.createElement('div', { className: 'col' }, a.createElement(V, e))
        );
      }
      function $(e) {
        ...
        return a.createElement(
          'div',
          { className: (0, m.Z)(y.k.docs.docFooterEditMetaRow, 'row') },
          a.createElement('div', { className: 'col' }, t && a.createElement(j, { editUrl: t })),
          a.createElement(
            'div',
            { className: (0, m.Z)('col', D) },
            (n || o) &&
              a.createElement(O, { lastUpdatedAt: n, formattedLastUpdatedAt: r, lastUpdatedBy: o })
          )
        );
      }
      function W() {
        ...
        return c || i
          ? a.createElement(
              'footer',
              { className: (0, m.Z)(y.k.docs.docFooter, 'docusaurus-mt-lg') },
              c && a.createElement(R, { tags: l }),
              i &&
                a.createElement($, {
                  editUrl: t,
                  lastUpdatedAt: n,
      ...
      function J(e) {
        ...
        return t.flatMap((e) => {
          const t = J({ toc: e.children, minHeadingLevel: n, maxHeadingLevel: a });
          return (function (e) {
        ...
        (0, a.useEffect)(() => {
          ...
          function c() {
            const e = (function (e) {
              ...
              s = X(c, { anchorTopOffset: n.current }),
              i = e.find(
                (e) =>
                  s &&
                  s.id ===
            ...
            e.forEach((e) => {
              !(function (e, n) {
                n
                  ? (t.current && t.current !== e && t.current.classList.remove(o),
                    e.classList.add(o),
                    (t.current = e))
      ...
      function ne(e) {
        ...
        const i = (0, q.L)(),
          ...
          p = (function (e) {
            ...
            return (0, a.useMemo)(
              () => J({ toc: G(t), minHeadingLevel: n, maxHeadingLevel: o }),
              [t, n, o]
            );
        ...
        return (
          ...
          a.createElement(te, (0, u.Z)({ toc: p, className: n, linkClassName: o }, s))
        );
      }
      const ae = 'tocCollapsibleButton_TO0P',
        oe = 'tocCollapsibleButtonExpanded_MG3E';
      function re(e) {
        let { collapsed: t, ...n } = e;
        return a.createElement(
          'button',
          (0, u.Z)({ type: 'button' }, n, {
            className: (0, m.Z)('clean-btn', ae, !t && oe, n.className),
          }),
          a.createElement(
            p.Z,
            {
      ...
      const le = 'tocCollapsible_ETCw',
        ce = 'tocCollapsibleContent_vkbj',
        se = 'tocCollapsibleExpanded_sAul';
      function ie(e) {
        let { toc: t, className: n, minHeadingLevel: o, maxHeadingLevel: r } = e;
        const { collapsed: l, toggleCollapsed: c } = (0, F.u)({ initialState: !0 });
        return a.createElement(
          'div',
          { className: (0, m.Z)(le, !l && se, n) },
          a.createElement(re, { collapsed: l, onClick: c }),
          a.createElement(
            F.z,
            { lazy: !0, className: ce, collapsed: l },
            a.createElement(ne, { toc: t, minHeadingLevel: o, maxHeadingLevel: r })
          )
        );
      }
      const me = 'tocMobile_ITEo';
      function de() {
        ...
        return a.createElement(ie, {
          ...
          className: (0, m.Z)(y.k.docs.docTocMobile, me),
        });
      }
      const ue = 'tableOfContents_bqdL';
      function pe(e) {
        let { className: t, ...n } = e;
        return a.createElement(
          'div',
          { className: (0, m.Z)(ue, 'thin-scrollbar', t) },
          a.createElement(
            ne,
            (0, u.Z)({}, n, {
      ...
      const he = 'anchorWithStickyNavbar_LWe7',
        ge = 'anchorWithHideOnScrollNavbar_WYt5';
      function be(e) {
        let { as: t, id: n, ...o } = e;
        const {
        ...
        return 'h1' !== t && n
          ? a.createElement(
              t,
              (0, u.Z)({}, o, { className: (0, m.Z)('anchor', r ? ge : he), id: n }),
              o.children,
              a.createElement(
                'a',
                {
          ...
          : a.createElement(t, (0, u.Z)({}, o, { id: void 0 }));
      }
      var ve = n(3905),
        Ee = n(5742);
      var ye = n(2389),
      ...
      function xe(e, t) {
        ...
        if (r && _e.test(r)) {
          const e = r.match(_e).groups.range;
          if (0 === o.length)
            throw new Error(
        ...
        const l = (function (e, t) {
            switch (e) {
              ...
              case 'ts':
              case 'typescript':
                return Ze(['js', 'jsBlock'], t);
              case 'jsx':
              case 'tsx':
                return Ze(['js', 'jsBlock', 'jsx'], t);
              case 'html':
                return Ze(['js', 'jsBlock', 'html'], t);
              case 'python':
              case 'py':
              case 'bash':
                return Ze(['bash'], t);
              case 'markdown':
              case 'md':
                return Ze(['html', 'jsx', 'bash'], t);
              default:
                return Ze(Object.keys(we), t);
            }
          })(a, o),
          c = n.split('\n'),
      ...
      const Be = 'codeBlockContainer_Ckt0';
      function Oe(e) {
        let { as: t, ...n } = e;
        const o = (function (e) {
        ...
        return a.createElement(
          t,
          (0, u.Z)({}, n, { style: o, className: (0, m.Z)(n.className, Be, y.k.common.codeBlock) })
        );
      }
      const Ae = {
      ...
      function He(e) {
        ...
        return a.createElement(
          Oe,
          {
            as: 'pre',
            tabIndex: 0,
            className: (0, m.Z)(Ae.codeBlockStandalone, 'thin-scrollbar', n),
          },
          a.createElement('code', { className: Ae.codeBlockLines }, t)
        );
      }
      const je = { attributes: !0, characterData: !0, childList: !0, subtree: !0 };
      function Se(e, t) {
      ...
      var Ie = { Prism: n(7410).Z, theme: Me };
      function Pe(e, t, n) {
        return (
          t in e
            ? Object.defineProperty(e, t, {
      ...
      var ze = /\r\n|\r|\n/,
        ...
        Re = function (e, t) {
          ...
          return (o.root = n), (o.plain = Ue({}, n, { backgroundColor: null })), o;
        };
      function $e(e, t) {
        var n = {};
        for (var a in e)
      ...
      const We = (function (e) {
          function t() {
            ...
            e.apply(this, n),
              Pe(this, 'getThemeDict', function (e) {
                if (
                  void 0 !== t.themeDict &&
                  e.theme === t.prevTheme &&
                ...
                var n = e.theme ? Re(e.theme, e.language) : void 0;
                return (t.themeDict = n);
              }),
              Pe(this, 'getLineProps', function (e) {
                var n = e.key,
                  a = e.className,
                  o = e.style,
                  r = Ue({}, $e(e, ['key', 'className', 'style', 'line']), {
                ...
                return (
                  ...
                  void 0 !== o && (r.style = void 0 !== r.style ? Ue({}, r.style, o) : o),
                  void 0 !== n && (r.key = n),
                  a && (r.className += ' ' + a),
                  r
                );
              }),
              Pe(this, 'getStyleForToken', function (e) {
                var n = e.types,
                  a = e.empty,
                  o = n.length,
              ...
              Pe(this, 'getTokenProps', function (e) {
                var n = e.key,
                  a = e.className,
                  o = e.style,
                  r = e.token,
                  l = Ue({}, $e(e, ['key', 'className', 'style', 'token']), {
                ...
                return (
                  void 0 !== o && (l.style = void 0 !== l.style ? Ue({}, l.style, o) : o),
                  void 0 !== n && (l.key = n),
                  a && (l.className += ' ' + a),
                  l
                );
              }),
              Pe(this, 'tokenize', function (e, t, n, a) {
          ...
          return (
            ...
            (t.prototype.render = function () {
              ...
              return o({
                tokens: (function (e) {
                  for (
                    var t = [[]], n = [e], a = [0], o = [e.length], r = 0, l = 0, c = [], s = [c];
                    l > -1;
                    ...
                    for (; (r = a[l]++) < o[l]; ) {
                      ...
                      if (
                        ('string' == typeof d
                          ? ((m = l > 0 ? m : ['plain']), (i = d))
                          : ((m = De(m, d.type)), d.alias && (m = De(m, d.alias)), (i = d.content)),
                        'string' == typeof i)
                      ) {
                        var u = i.split(ze),
                          p = u.length;
                        ...
                        for (var f = 1; f < p; f++)
                          Ve(c), s.push((c = [])), c.push({ types: m, content: u[f] });
                      } else l++, t.push(m), n.push(i), a.push(0), o.push(i.length);
                    }
        ...
        return a.createElement(
          ...
          o
            ? a.createElement(
                ...
                a.createElement('span', { className: Ge }, s)
              )
            : s,
        ...
        return (
          ...
          a.createElement(
            'button',
            {
              ...
              className: (0, m.Z)('clean-btn', n, Qe.copyButton, o && Qe.copyButtonCopied),
              onClick: c,
            },
            a.createElement(
              'span',
              { className: Qe.copyButtonIcons, 'aria-hidden': 'true' },
              a.createElement(
                'svg',
                { className: Qe.copyButtonIcon, viewBox: '0 0 24 24' },
                a.createElement('path', {
              ...
              a.createElement(
                'svg',
                { className: Qe.copyButtonSuccessIcon, viewBox: '0 0 24 24' },
                a.createElement('path', {
      ...
      const Ye = 'wordWrapButtonIcon_Bwma',
      ...
      function et(e) {
        ...
        return a.createElement(
          'button',
          {
            type: 'button',
            onClick: n,
            className: (0, m.Z)('clean-btn', t, o && Ke),
            'aria-label': r,
            title: r,
          },
          a.createElement(
            'svg',
            { className: Ye, viewBox: '0 0 24 24', 'aria-hidden': 'true' },
            a.createElement('path', {
              fill: 'currentColor',
      ...
      function tt(e) {
        ...
        const p = Ne(),
          ...
          h =
            (function (e) {
              return e?.match(Te)?.groups.title ?? '';
            })(o) || r,
          { lineClassNames: g, code: b } = xe(t, { metastring: o, language: d, magicComments: i }),
          v =
            l ??
            (function (e) {
        ...
        return a.createElement(
          ...
          {
            as: 'div',
            className: (0, m.Z)(n, d && !n.includes(`language-${d}`) && `language-${d}`),
          },
          h && a.createElement('div', { className: Ae.codeBlockTitle }, h),
          a.createElement(
            'div',
            { className: Ae.codeBlockContent },
            a.createElement(
              We,
              (0, u.Z)({}, Ie, { theme: p, code: b, language: d ?? 'text' }),
              (e) => {
                ...
                return a.createElement(
                  'pre',
                  {
                    tabIndex: 0,
                    ref: f.codeBlockRef,
                    className: (0, m.Z)(t, Ae.codeBlock, 'thin-scrollbar'),
                  },
                  a.createElement(
                    'code',
                    { className: (0, m.Z)(Ae.codeBlockLines, v && Ae.codeBlockLinesWithNumbering) },
                    n.map((e, t) =>
                      a.createElement(Je, {
                        key: t,
                        line: e,
            ...
            a.createElement(
              ...
              (f.isEnabled || f.isCodeScrollable) &&
                a.createElement(et, {
                  className: Ae.codeButton,
                  onClick: () => f.toggle(),
                  isEnabled: f.isEnabled,
                }),
              a.createElement(Xe, { className: Ae.codeButton, code: b })
            )
          )
        );
      }
      function nt(e) {
        ...
        const o = (0, ye.Z)(),
          r = (function (e) {
            return a.Children.toArray(e).some((e) => (0, a.isValidElement)(e))
              ? e
              : Array.isArray(e)
              ? e.join('')
              : e;
          })(t),
          l = 'string' == typeof r ? tt : He;
        return a.createElement(l, (0, u.Z)({ key: String(o) }, n), r);
      }
      const at = 'details_lb9f',
        ot = 'isBrowser_bmU9',
        rt = 'collapsibleContent_i85q';
      function lt(e) {
        return !!e && ('SUMMARY' === e.tagName || lt(e.parentElement));
      }
      function ct(e, t) {
        return !!e && (e === t || ct(e.parentElement, t));
      }
      function st(e) {
        let { summary: t, children: n, ...o } = e;
        const r = (0, ye.Z)(),
          l = (0, a.useRef)(null),
          { collapsed: c, setCollapsed: s } = (0, F.u)({ initialState: !o.open }),
          [i, d] = (0, a.useState)(o.open);
        return a.createElement(
          'details',
          (0, u.Z)({}, o, {
            ref: l,
            open: i,
            'data-collapsed': c,
            className: (0, m.Z)(at, r && ot, o.className),
            onMouseDown: (e) => {
              lt(e.target) && e.detail > 1 && e.preventDefault();
            },
            onClick: (e) => {
              e.stopPropagation();
              const t = e.target;
              lt(t) && ct(t, l.current) && (e.preventDefault(), c ? (s(!1), d(!0)) : s(!0));
            },
          }),
          ...
          a.createElement(
            ...
            a.createElement('div', { className: rt }, n)
          )
        );
      }
      const it = 'details_b_Ee';
      function mt(e) {
        let { ...t } = e;
        return a.createElement(
          st,
          (0, u.Z)({}, t, { className: (0, m.Z)('alert alert--info', it, t.className) })
        );
      }
      function dt(e) {
        return a.createElement(be, e);
      }
      const ut = 'containsTaskList_mC6p';
      const pt = 'img_ev3q';
      const ft = 'admonition_LlT9',
        ht = 'admonitionHeading_tbUL',
        gt = 'admonitionIcon_kALy',
        bt = 'admonitionContent_S0QG';
      const vt = {
          note: {
        ...
        Et = { secondary: 'note', important: 'info', success: 'tip', warning: 'danger' };
      function yt(e) {
      ...
      const kt = {
        head: function (e) {
          ...
          return a.createElement(Ee.Z, e, t);
        },
        code: function (e) {
          const t = [
            'a',
        ...
        details: function (e) {
          ...
          return a.createElement(mt, (0, u.Z)({}, e, { summary: n }), o);
        },
        ul: function (e) {
          return a.createElement(
            'ul',
            (0, u.Z)({}, e, {
              className: ((t = e.className), (0, m.Z)(t, t?.includes('contains-task-list') && ut)),
            })
          );
          var t;
        },
        img: function (e) {
          return a.createElement(
            'img',
            (0, u.Z)({ loading: 'lazy' }, e, { className: ((t = e.className), (0, m.Z)(t, pt)) })
          );
          var t;
        },
        h1: (e) => a.createElement(dt, (0, u.Z)({ as: 'h1' }, e)),
        h2: (e) => a.createElement(dt, (0, u.Z)({ as: 'h2' }, e)),
        h3: (e) => a.createElement(dt, (0, u.Z)({ as: 'h3' }, e)),
        h4: (e) => a.createElement(dt, (0, u.Z)({ as: 'h4' }, e)),
        h5: (e) => a.createElement(dt, (0, u.Z)({ as: 'h5' }, e)),
        h6: (e) => a.createElement(dt, (0, u.Z)({ as: 'h6' }, e)),
        admonition: function (e) {
          const { children: t, type: n, title: o, icon: r } = yt(e),
            l = (function (e) {
              const t = Et[e] ?? e,
                n = vt[t];
              return (
          ...
          return a.createElement(
            ...
            a.createElement(
              'div',
              { className: ht },
              a.createElement('span', { className: gt }, i),
              c
            ),
            a.createElement('div', { className: bt }, t)
          );
        },
        mermaid: n(1875).Z,
      };
      function Nt(e) {
        let { children: t } = e;
        return a.createElement(ve.Zo, { components: kt }, t);
      }
      function Lt(e) {
        let { children: t } = e;
        const n = (function () {
        ...
        return a.createElement(
          'div',
          { className: (0, m.Z)(y.k.docs.docMarkdown, 'markdown') },
          n && a.createElement('header', null, a.createElement(be, { as: 'h1' }, n)),
      ...
      function Bt(e) {
        ...
        return a.createElement(
          ...
          (0, u.Z)(
            ...
            { className: (0, m.Z)('breadcrumbs__item', { 'breadcrumbs__item--active': n }) }
          ),
          t,
        ...
        return a.createElement(
          ...
          a.createElement(
            f.Z,
            {
              ...
              className: (0, m.Z)('breadcrumbs__link', Zt.breadcrumbsItemLink),
              href: e,
            },
            a.createElement(wt, { className: Zt.breadcrumbHomeIcon })
          )
        );
      }
      function At() {
        ...
        return e
          ? a.createElement(
              'nav',
              {
                className: (0, m.Z)(y.k.docs.docBreadcrumbs, Zt.breadcrumbsContainer),
                'aria-label': (0, p.I)({
              ...
              a.createElement(
                ...
                t && a.createElement(Ot, null),
                e.map((t, n) => {
                  const o = n === e.length - 1;
                  return a.createElement(
                    Bt,
                    { key: n, active: o, index: n, addMicrodata: !!t.href },
                    a.createElement(xt, { href: t.href, isLast: o }, t.label)
                  );
                })
              )
            )
      ...
      const Ht = 'docItemContainer_Djhp',
        jt = 'docItemCol_VOVn';
      function St(e) {
        let { children: t } = e;
        const n = (function () {
          ...
          return {
            hidden: o,
            mobile: r ? a.createElement(de, null) : void 0,
            desktop: !r || ('desktop' !== n && 'ssr' !== n) ? void 0 : a.createElement(fe, null),
          };
        })();
        return a.createElement(
          'div',
          ...
          a.createElement(
            'div',
            { className: (0, m.Z)('col', !n.hidden && jt) },
      ...
      function Mt(e) {
        ...
        return a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(St, null, a.createElement(n, null))
          )
        );
      }
    },
